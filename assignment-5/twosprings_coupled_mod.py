...
t, x1, x2, v1, v2 = loadtxt ('twospring_coupled_mod.dat', unpack = True)
...
title('Displacement of 2 Coupled-Mass Spring Systems(Modified)')
savefig('Coupled_Springs_Mod.png', dpi = 200)


#########Commment############

# As with the previous coupled spring, we first observe that the 
#   elastic force gives us a total driving force acting on each mass. 
#   Though they have the same mass, they have different positions, so 
#   they therefore have 2 accelerations, and thus two different
#   potential energies and forces.


# Now that the springs are further apart, the spring is expanded.
# We therefore see that the vertical position between two springs become greater. 

# We observe a longer oscillation between the two masses, so the system
#     takes longer to achieve equilibrium. 
#     The total energy increases; the potential energy increases, though
