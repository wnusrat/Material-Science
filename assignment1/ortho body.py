# similar to tetra body, now just have all 3 vectors multiplied by 2 for z component
...
a1 = np.array([-0.5, 0.5, 1.0]) 
a2 = np.array([0.5, -1.0, 1.0])
a3 = np.array([0.5,0.5,-1.0])

#a1 = np.array([1.0, .0, .0])
#a2 = np.array([.0, 1.0, .0])
#a3 = np.array([0.5, 0.5, 0.5])

outputFile = open('ortho body.xyz', 'w')
