# same as bcc, except now the third vector is multiplied by 3
...
a1 = np.array([-0.5, 0.5, 1.5]) 
a2 = np.array([0.5, -0.5, 1.5])
a3 = np.array([0.5,0.5,-1.5])

#a1 = np.array([1.0, .0, .0])
#a2 = np.array([.0, 1.0, .0])
#a3 = np.array([0.5, 0.5, 0.5])

outputFile = open('tetra body.xyz', 'w')
