# as with the scc and bcc, a (simple) fcc has a given set of vectors commonly appointed. Here we use the vectors for 
# suggested symmetry of the lattice
...
outputFile = open('simple fcc.xyz', 'w')
